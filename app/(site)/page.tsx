...
export default async function HomePage({ searchParams }: Props) {
  ...
  return (
    <section className='md:px-20 xxl:mx-auto xxl:w-6/12'>
      ...
      <div className='relative my-10 mx-auto flex w-11/12 flex-col justify-between rounded-lg bg-deepGray py-10 shadow-lg md:w-11/12 md:flex-row md:p-5 lg:w-8/12'>
        <SearchForm />
